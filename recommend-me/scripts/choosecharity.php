 ...
 * just replace email address with your email address
 ---------------------------------------------*/
$address = "williamboudle@gmail.com"; 
...
$name     = $_POST['name-charity'];
$email    = $_POST['email-charity'];
$company  = $_POST['company-charity'];
$msg = $_POST['name-charity']." from ".$_POST['company-charity']." recommended you and would like you to donate to ".$_POST['charity'].$_POST['charity-other'];
...
$e_body = "You have been recommended by $name" . PHP_EOL . PHP_EOL;
